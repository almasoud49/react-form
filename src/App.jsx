...
function App() {
  ...
  return <div className="p-8 flex justify-around">
  <form className="bg-gray-200 p-2 rounded w-1/2 mr-4">
  <div className="my-2">
    <label className="mx-4" htmlFor="fname">Full Name</label>
    <input 
    type="text"
    name="fname"
    id="fname"
  ...
  <div className="my-2">
    <label className="mx-4" htmlFor="color">color</label>
    <input 
    type="color"
    name="color"
    value={contact.color}
  ...
  <div className="my-2">
    <label className="mx-4" htmlFor="address">address</label>
    <input 
    type="address"
    name="address"
  ...
  <div className="my-2">
    <label className="mx-4" htmlFor="state">State</label>
      <select name="state" id="state" value={contact.state}
            className="border border-gray-400 rounded p-1" 
  ...
  <div className="mx-4">
    <label className="my-4" htmlFor="zip">Pin/Zip</label>
    <input
    type="number"
    name="zip"
    id="zip"
